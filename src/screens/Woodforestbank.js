...
import ProductList from "./woodforest.json";
import {
...
export default function Woodforestbank() {
  const [Bank, setBank] = useState("WOODFOREST");
        ...
        <div className={reducedWidth ? "pamela2 " : "pamela"}>
            ...
            <tbody>
              {paginatedPost.map((item) => (
                <tr>
                  ...
                  <td>
                    <Link
                      to={`/invoice/woodforestbank/${item.buy}`}
                      state={{ from: "woodforest", amount: `${item.buy}` }}
                    >
          ...
          <div className="joinandFootter">
            ...
            <div className="footer">
              copyright &copy; 2022 Darknetz.web All rights reserved.
            </div>
          </div>
        </div>
      </div>
